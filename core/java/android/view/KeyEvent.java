...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    /** Key code constant: tri-state key. */
   // public static final int KEYCODE_TRI_STATE_TOP = 260;
    //public static final int KEYCODE_KEY_TRI_STATE_MID = 261;
    //public static final int KEYCODE_KEY_TRI_STATE_BOTTOM = 262;
    public static final int KEYCODE_XTOP = 260;
    public static final int KEYCODE_XMID = 261;
    public static final int KEYCODE_XBOTTOM = 262;


    private static final int LAST_KEYCODE = KEYCODE_XBOTTOM;
